...
class Config {
  ...
  defaultMainnetConfig(): Partial<IClientConfig> {
    return {
      ...
      contracts: {
        PolygonToSecret: {
          address: "0x966FC0AC7f9b9232a9A9906fc31Ff6a2c2ebEBcc",
          abi: PolygonToSecretAbi.abi,
        },
        ShareDocument: {
          address: "secret1kzejyxq0kmecx2455crw78uwrqkwref35kd7a6",
          hash: "0bbc0a2b7312513044f1ebc69e0f7f785963a00d488d160fd01d46acdff7cea6",
        },
      },
      wallets: {
        secretNetwork: {
